...
function createObject(i)
  ...
  if img[i]["@transform"] ~= nil then
    textures[i].w = -textures[i].w
    textures[i].xScale = -1
  end

  return textures[i].x, textures[i].y, textures[i].h, textures[i].w, textures[i].u, textures[i].v, textures[i].uSize, textures[i].vSize, textures[i].xScale
end
